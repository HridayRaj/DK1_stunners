...
function createDownloadLink(blob) {
	...
	//upload link
      ...
      function dologin(){
        ...
        document.getElementById("loganiimg").src = "/static/img/gpsdone.png";
        document.getElementById("bly").innerHTML = "Your Voice is recognized";
        document.getElementById("bly").style.color = "#00FFEF"
        document.getElementById("loma").innerHTML = "Click Login to check match result !";
